...
async def amireallyalive(alive):
    ...
    output = (
        ...
        f"╰✠╼━━━━━━❖━━━━━━━✠╯\n"
        f"▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰ \n"
        f"[𝐈𝐍𝐒𝐓𝐀𝐆𝐑𝐀𝐌]({IG_ALIVE}) || [{REPO_NAME}](https://github.com/bagasgetas1/bagasRam) || [𝐆𝐑𝐎𝐔𝐏]({GROUP_LINK}) \n"
        f"▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰")
    if ALIVE_LOGO:
        try:
            logo = ALIVE_LOGO
...
async def amireallyalive(alive):
    ...
    output = (
        ...
        f"❃ **Modul**           ➥ `{len(modules)}` \n\n"
        f"**▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰**\n"
        f"[{REPO_NAME}](https://github.com/bagasgetas1/bagasRam) || [𝗚𝗥𝗢𝗨𝗣]({GROUP_LINK}) || [𝗜𝗡𝗦𝗧𝗔𝗚𝗥𝗔𝗠]({IG_ALIVE})\n"
        f"**▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰ **")
    if ALIVE_LOGO:
        try:
            logo = ALIVE_LOGO
...
async def amireallyalive(alive):
    ...
    output = (
        ...
        f"╰✠╼━━━━━━❖━━━━━━━✠╯ \n"
        f"▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰ \n"
        f"[{REPO_NAME}](https://github.com/bagasgetas1/bagasRam) || [𝐆𝐑𝐎𝐔𝐏]({GROUP_LINK}) || [𝐈𝐍𝐒𝐓𝐀𝐆𝐑𝐀𝐌]({IG_ALIVE}) \n"
        f"▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰")
    if ALIVE_LOGO:
        try:
            logo = ALIVE_LOGO
